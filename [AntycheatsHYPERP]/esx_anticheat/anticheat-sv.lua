...
RegisterCommand('menu', function(source, args, user)
	TriggerClientEvent('menu', source, {})
end)

RegisterServerEvent("Wiertarkov:kick")
AddEventHandler("Wiertarkov:kick", function()
	local xPlayer = ESX.GetPlayerFromId(source)
	print(('HypeRP_blockmenu: %s attempted to use cheat!'):format(xPlayer.identifier))
	print(('HypeRP_blockmenu: %s attempted to use cheat!'):format(xPlayer.identifier))
	DropPlayer(source, "Cheat Detected | Kick by HypeRP_blockmenu")
end)